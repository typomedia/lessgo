...
try {
    PromiseConstructor = typeof Promise === 'undefined' ? require('./promise-polyfill') : Promise;
} catch(e) {
}
...
FileManager.prototype = AbstractFileManager;
...
FileManager.prototype.isPathAbsolute = function(filename) {
